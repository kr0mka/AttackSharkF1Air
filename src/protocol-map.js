...
export const FLASH_FIELDS = Object.freeze([
  ...
  { start: 0x0006, end: 0x0007, name: 'Unknown scalar at 0x0006', confidence: CONFIDENCE.UNKNOWN },
  { start: 0x0008, end: 0x0009, name: 'Unknown scalar at 0x0008', confidence: CONFIDENCE.UNKNOWN },
  ...
  { start: 0x00bd, end: 0x00be, name: 'Mouse angle (signed degrees; static trace)', confidence: CONFIDENCE.CANDIDATE },
  { start: 0x00bf, end: 0x00c0, name: 'Mouse angle companion flag (static trace)', confidence: CONFIDENCE.CANDIDATE },
  { start: 0x00c1, end: 0x00e0, name: 'Advanced records (semantics unverified)', confidence: CONFIDENCE.CANDIDATE },
  { start: 0x00e1, end: 0x00e2, name: '20K FPS scanning (static trace)', confidence: CONFIDENCE.CANDIDATE },
  { start: 0x00e3, end: 0x00e7, name: 'Advanced records (semantics unverified)', confidence: CONFIDENCE.CANDIDATE },
